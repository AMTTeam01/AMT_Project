...
CREATE TABLE IF NOT EXISTS `help2000`.`tblComment` (
  ...
  `description` LONGTEXT NOT NULL,
  `creationDate` DATETIME NOT NULL,
  `tblAnswer_id` INT NULL DEFAULT NULL,
  `tblQuestion_id` INT NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
-- Table `help2000`.`tblUser_vote_tblAnswer`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `help2000`.`tblUser_vote_tblAnswer` (
  `tblUser_id` INT NOT NULL,
  `tblAnswer_id` INT NOT NULL,
  INDEX `fk_tblUser_has_tblAnswer_tblAnswer1_idx` (`tblAnswer_id` ASC) VISIBLE,
  INDEX `fk_tblUser_has_tblAnswer_tblUser1_idx` (`tblUser_id` ASC) VISIBLE,
  PRIMARY KEY (`tblUser_id`, `tblAnswer_id`),
  CONSTRAINT `fk_tblUser_has_tblAnswer_tblUser1`
    FOREIGN KEY (`tblUser_id`)
    REFERENCES `help2000`.`tblUser` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tblUser_has_tblAnswer_tblAnswer1`
    FOREIGN KEY (`tblAnswer_id`)
    REFERENCES `help2000`.`tblAnswer` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
