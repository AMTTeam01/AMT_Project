...
<div class="container-fluid body-with-navbar">
    <div class="row">
        <div class="col">
            ...
            <div class="row justify-content-center">${question.votes}</div>
            <a href="${pageContext.request.contextPath}/vote?vote=downvote&id=${question.id.asString()}" name="btn_down" class="row justify-content-center"><i class="fas fa-arrow-alt-circle-down"></i></a>
        </div>
        <div class="col-10">
